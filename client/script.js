...
function originalButtonColor(event) {
    sayHelloButton.style.backgroundColor = "#EFEFEF";
    sayHelloButton.style.color = "black"
}

sayHelloButton.addEventListener("mouseout", originalButtonColor)
...
const repeatMyParam = () => {
    ...
    return axios.get('http://localhost:3000/repeat/Req-Res-Lab')
        .then(res => res.data)
}
...
// axios.get('http://localhost:3000/repeat?myquery=woo-hoo-almost-done')
